...
_lr_productions = [
  ...
  ('atom -> SIMB','atom',1,'p_atom_simbol','yacc.py',191),
  ('atom -> bool','atom',1,'p_atom_bool','yacc.py',195),
  ('atom -> NUM','atom',1,'p_atom_num','yacc.py',199),
  ('atom -> TEXT','atom',1,'p_atom_word','yacc.py',203),
  ('atom -> <empty>','atom',0,'p_atom_empty','yacc.py',207),
  ('bool -> TRUE','bool',1,'p_true','yacc.py',211),
  ('bool -> FALSE','bool',1,'p_false','yacc.py',215),
  ('atom -> NIL','atom',1,'p_nil','yacc.py',219),
]
